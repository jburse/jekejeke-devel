...
:- foreign(node_is_elem/1, 'ForeignModel', sysNodeIsElem('AbstractDom')).
...
:- foreign(node_is_text/1, 'ForeignModel', sysNodeIsText('AbstractDom')).
 ...
 */
:- public node_copy/2.
:- foreign(node_copy/2, 'ForeignModel', sysNodeCopy('AbstractDom')).
...
:- foreign(text_get_data/2, 'ForeignModel', sysGetData('DomText')).
