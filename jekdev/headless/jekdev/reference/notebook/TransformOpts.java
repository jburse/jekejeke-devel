...
final class TransformOpts extends SerializeOpts {
     ...
     */
    public static TransformOpts decodeTransformOpts(Object opt)
            throws InterpreterMessage {
        try {
            TransformOpts res = new TransformOpts();
