...
public class SupervisorCall {
     ...
     * @param en The engine.
     */
    public void countBody(Object b, Display c, Engine en) {
        en.skel = b;
        en.display = c;
        en.deref();
        b = en.skel;
     ...
     * @param en The engine.
     */
    public void countDisj(Object t, Display d, Engine en) {
     ...
     * @param en The engine.
     */
    public void countCond(Object b, Display c, Engine en) {
