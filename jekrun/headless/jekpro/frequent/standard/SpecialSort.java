        ...
        try {
            switch (id) {
                ...
                case SPECIAL_SYS_HASH_CODE:
                    ...
                    if (!BindUniv.unifyClash(val, Display.DISPLAY_CONST, temp[2], ref, en))
                        return false;
                    return true;
                case SPECIAL_NUMBER_TEST:
                    ...
                    if (!BindUniv.unifyClash(SpecialLexical.compAtom(res2, en), Display.DISPLAY_CONST, temp[0], ref, en))
                        return false;
                    return true;
                default:
