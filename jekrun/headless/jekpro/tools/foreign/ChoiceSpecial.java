 ...
 */
final class ChoiceSpecial extends AbstractChoice {
    CallOut co;
    MemberSpecialNondet del;
    Object obj;
    Object[] args;
    AbstractUndo mark;
     ...
     */
    ChoiceSpecial(AbstractChoice n, CallFrame u) {
        super(n, u);
    }
    ...
    public final boolean moniNext(Engine en)
        ...
        for (; ; ) {
            ...
            Object res;
            if (del.special != null) {
                res = MemberSpecialDet.invokeSpecial(del.special, obj, args);
            } else {
                throw MemberSpecialDet.existenceProvable(del, en);
            }
    ...
    public final void moniCut(Engine en) {
        ...
        try {
            ...
            if (del.special != null) {
                MemberSpecialDet.invokeSpecial(del.special, obj, args);
            } else {
                throw MemberSpecialDet.existenceProvable(del, en);
            }
